...
ActiveRecord::Schema.define(:version => 20141120193802) do
  ...
  create_table "refinery_saloons", :force => true do |t|
    t.string   "title"
    t.text     "body"
    t.string   "adress"
    t.string   "phone"
  ...
  create_table "refinery_subscribers", :force => true do |t|
    t.string   "email"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "refinery_vacancies", :force => true do |t|
    t.string   "title"
    t.text     "body"
    t.integer  "position"
    t.datetime "created_at", :null => false
